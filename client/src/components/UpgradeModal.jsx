...
import { RiVipCrownFill, RiCloseLine, RiInfinityLine, RiRobot2Line, RiChat3Line } from 'react-icons/ri'
      ...
      <div className="upgrade-modal" onClick={e => e.stopPropagation()}>
        ...
        <div className="upgrade-modal__features">
          <div className="upgrade-modal__feature">
            <RiInfinityLine /> Unlimited job applications
          </div>
          <div className="upgrade-modal__feature">
            <RiRobot2Line /> AI Cover Letter Generator
          </div>
          <div className="upgrade-modal__feature">
            <RiChat3Line /> AI Interview Question Generator
          </div>
        </div>
